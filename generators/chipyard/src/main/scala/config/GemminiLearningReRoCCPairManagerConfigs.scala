...
class GemminiLearningConfigSpadReRoCCGlobalNoC2C1x2P2x1x2CoupledDMAPairManagerDefault4x4Sbus128
  extends GemminiLearningConfigSpadReRoCCNoCPairManagerParametric(
    numCores = 2,
    cpuX = 1,
    cpuY = 2,
...
class GemminiLearningConfigSpadReRoCCGlobalNoC4C2x2P8x4x2CoupledDMAPairManagerDummy16x16Sbus128
  extends GemminiLearningConfigSpadReRoCCNoCPairManagerParametric(
    numCores = 4,
    cpuX = 2,
    cpuY = 2,
...
class GemminiLearningConfigSpadReRoCCGlobalNoC4C2x2P12x4x3CoupledDMAPairManagerDummy8x8Sbus64
  extends GemminiLearningConfigSpadReRoCCNoCPairManagerParametric(
    numCores = 4,
    cpuX = 2,
    cpuY = 2,
