#ifndef MUDNACSIM_SPM_NOC_SYSTEM_H
#define MUDNACSIM_SPM_NOC_SYSTEM_H
...
namespace mudnac {
    ...
    class BaseSPMNoCSystem : public BaseSPMSystem, public BaseNoCSystem {
    public:
        ...
        BaseSPMNoCSystem(SystemConfig &config,
            ...
            for (uint64 i = 0; i < config.cacheBanks; i++){
                ...
                spm.assignPort(i, cacheBankMasterPorts[i], cacheBankSlavePorts[i]);
            }
            for (uint64 i = 0; i < config.accelNum; i++){
    ...
    class SPMNoCSystemHomoTileMesh : public BaseSPMNoCSystem {
    protected:
        MeshNoC meshNoc0;
        MeshNoC meshNoc1;
    ...
    public:
        SPMNoCSystemHomoTileMesh(SystemConfig &config,
                                 ...
                                 bool shared)
                : BaseSPMNoCSystem(config, noc0NiConfig, noc1NiConfig, shared) {

            // Compute the shape of mesh
            computeMeshShape(config);
            printf("SPMNoCSystemHomoTileMesh: H=%lu, W=%lu, accelNumPerTile=%lu\n", H, W, accelNumPerTile);
...
#endif //MUDNACSIM_SPM_NOC_SYSTEM_H
