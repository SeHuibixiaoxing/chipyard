...
def EfficientNetB0(pipeline: bool=False) -> Model:
    ir_list = [4,
               4,
               4,
               4,
...
def EfficientNetB1(pipeline: bool=False) -> Model:
